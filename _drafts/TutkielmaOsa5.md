...
Olkoon $A \in \mathbb{Z_*}[x]$ jaoton, ja olkoon $\alpha$ sen juuri. Olkoon $p$ alkuluku, joka ei jaa $A$:n korkeimman asteen termin kerrointa. Väitän, että $\mathbb{Z}_p(\alpha)$ on rengas, eli siis eritysesti kahden joukon $\mathbb{Z}_p(\alpha)$ tulo on myös tämän joukon alkio.
