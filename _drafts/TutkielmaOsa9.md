...
Olkoon $k \in \mathbb{Z_+}$, ja olkoon $S$ niiden $1 \le n \le k$ joukko, joilla $syt(n, k) = 1$. Olkoon $H$ jokin $S$:n osajoukko, joka on kertolaskun suhteen suljettu, kun kertolasku tehdään modulo $k$. On olemassa polynomi $P \in \mathbb{Z_*}[x]$, jolla on seuraavat ominaisuudet:
