...
Olkoon polynomin $P \in \mathbb{Q_*}[x]$ juuret $\alpha_1, \alpha_2, \ldots , \alpha_n$. Polynomin $P$ juurikunta määritellään olemaan kunta $\mathbb{Q}(\alpha_1, \alpha_2, \ldots , \alpha_n)$.
